    ...
    <div class="widget-inside">
        <form method="post">
            <div class="widget-content">
                ...
                <p>
                    <label for="widget-item-__i__-rating-slider-from">No rating from</label>
                    <input class="widefat " id="widget-item-__i__-rating-slider-from" name="widget-item[__i__][rating-slider-from]" type="number" step="1" min="1" max="" value="0">
                </p>
                <p>
                    <label for="widget-item-__i__-rating-slider-to">No rating to</label>
                    <input class="widefat " id="widget-item-__i__-review-slider-from" name="widget-item[__i__][rating-slider-from]" type="number" step="1" min="1" max="" value="100">
                </p>
            </div>
