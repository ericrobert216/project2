    ...
    <div class="item-inside">
        <form method="post">
            <div class="item-content">
                ...
                <p>
                    <label for="item-item-__i__-review-slider-from">No review from</label>
                    <input class="widefat " id="item-item-__i__-review-slider-from" name="item-item[__i__][review-slider-from]" type="number" step="1" min="1" max="" value="0">
                </p>
                <p>
                    <label for="item-item-__i__-review-slider-to">No review to</label>
                    <input class="widefat " id="item-item-__i__-review-slider-from" name="item-item[__i__][review-slider-from]" type="number" step="1" min="1" max="" value="100">
                </p>
            </div>
